...
//	}
	...
	// std::string TagRECTYPE = "***AUREA FILE***TTResultFormat_TTTRRecType      ˇˇˇˇ      ";	// HydraHarp, T2
	
	// Very bad solution: cast all the others to tyInt8 = 0x10000008, //
	
	std::string TagPREHEADER16bytes = "***AUREA FILE***";
	//std::string TagRECTYPE = "TTResultFormat_TTTRRecType      ˇˇˇˇ      ";	// HydraHarp, T2
	//std::string TagNUMREC = "TTResult_NumberOfRecords        ˇˇˇˇ  "; // + append 8 bytes (uint64) <NcntsTOT>
	//std::string TagGLOBRES = "MeasDesc_GlobalResolution       ˇˇˇˇ   Í-Åôóq="; // 1 ps == standard
	//std::string TagACQTIME = "MeasDesc_AcquisitionTime        ˇˇˇˇ  "; // + append 8 bytes (uint64) <inMeasTime>
	//std::string TagHEADEREND = "Header_End                      ˇˇˇˇ ˇˇ        "; // no change
